...
var e=window.wp.i18n.__,t=window.wp.element,o=t.createElement,r=t.Fragment,c=window.wp.richText,i=c.registerFormatType,n=c.unregisterFormatType,a=c.toggleFormat,l=window.wp.editor,s=l.RichTextToolbarButton,d=l.RichTextShortcut,u="core/code";n(u),i(u,{title:e("Code"),tagName:"code",className:null,edit:function(t){var c=t.isActive,i=t.value,n=t.onChange,l=function(){return n(a(i,{type:u}))};return o(r,null,o(d,{type:"access",character:"x",onUse:l}),o(s,{icon:"editor-code",title:e("Code"),onClick:l,isActive:c,shortcutType:"access",shortcutCharacter:"x"}))}});
...
},{"./es6.array.iterator":"2xsA","./_object-keys":"kfVX","./_redefine":"2l2h","./_global":"kql1","./_hide":"i5RL","./_iterators":"oANp","./_wks":"3Mgd"}],"iJA9":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.I18N_NAMESPACE=void 0;var e="advanced-rich-text-tools";exports.I18N_NAMESPACE=e;
},{}],"nmUB":[function(require,module,exports) {
"use strict";require("core-js/modules/es6.regexp.constructor"),require("core-js/modules/es6.regexp.replace"),require("core-js/modules/es6.function.name"),require("core-js/modules/web.dom.iterable");var e=require("./constants"),t=window.wp.i18n.__,o=window.wp.element.createElement,r=window.wp.richText,n=r.registerFormatType,a=r.applyFormat,l=r.removeFormat,i=r.getActiveFormat,c=window.wp.editor,s=c.InspectorControls,u=c.PanelColorSettings;[{name:"color",title:t("Inline Text Colour",e.I18N_NAMESPACE)},{name:"background-color",title:t("Inline Background Colour",e.I18N_NAMESPACE)}].forEach(function(r){var c=r.name,m=r.title,p="advanced/".concat(c);n(p,{title:m,tagName:"span",className:c,attributes:{style:"style"},edit:function(r){var n,d=r.isActive,w=r.value,g=r.onChange;d&&(n=i(w,p).attributes.style.replace(new RegExp("^".concat(c,":\\s*")),""));return o(s,null,o(u,{title:m,initialOpen:!0,colorSettings:[{value:n,onChange:function(e){g(e?a(w,{type:p,attributes:{style:"".concat(c,":").concat(e)}}):l(w,p))},label:t("Apply colour to the selected text.",e.I18N_NAMESPACE)}]}))}})});
},{"core-js/modules/es6.regexp.constructor":"hBwo","core-js/modules/es6.regexp.replace":"eUHu","core-js/modules/es6.function.name":"WtEG","core-js/modules/web.dom.iterable":"hFdU","./constants":"iJA9"}],"Gl4i":[function(require,module,exports) {
var e=require("./_cof");module.exports=Object("z").propertyIsEnumerable(0)?Object:function(r){return"String"==e(r)?r.split(""):Object(r)};
...
"use strict";var e=n(require("@babel/runtime-corejs2/helpers/objectSpread")),t=require("./constants");function n(e){return e&&e.__esModule?e:{default:e}}var r=window.wp.i18n.__,o=window.wp.element.createElement,a=window.wp.richText.registerFormatType,i=window.wp.editor.InspectorControls,l=window.wp.components,m=l.PanelBody,s=l.Button,u="advanced/remove-formatting";a(u,{title:r("Remove formatting",t.I18N_NAMESPACE),tagName:"span",className:"remove",edit:function(n){n.isActive;var a=n.value,l=n.onChange;return o(i,null,o(m,{title:r("Remove Formatting",t.I18N_NAMESPACE)},o(s,{isDefault:!0,onClick:function(){return l((0,e.default)({},a,{formats:Array(a.formats.length)}))}},r("Remove All formatting",t.I18N_NAMESPACE))))}});
},{"@babel/runtime-corejs2/helpers/objectSpread":"ES/5","./constants":"iJA9"}],"u88s":[function(require,module,exports) {
"use strict";require("core-js/modules/es6.function.name"),require("core-js/modules/web.dom.iterable");var t=require("./constants"),e=window.wp.i18n.__,r=window.wp.element,a=r.createElement,c=r.Fragment,n=window.wp.richText,o=n.registerFormatType,i=n.toggleFormat,u=window.wp.editor,s=u.RichTextToolbarButton,l=u.RichTextShortcut;[{name:"sup",title:e("Superscript",t.I18N_NAMESPACE),character:"."},{name:"sub",title:e("Subscript",t.I18N_NAMESPACE),character:","}].forEach(function(t){var e=t.name,r=t.title,n=t.character,u=(t.icon,"advanced/".concat(e));o(u,{title:r,tagName:e,className:null,edit:function(t){var o=t.isActive,m=t.value,h=t.onChange,p=function(){return h(i(m,{type:u}))};return a(c,null,a(l,{type:"primary",character:n,onUse:p}),a(s,{title:r,onClick:p,isActive:o,shortcutType:"primary",shortcutCharacter:n,className:"toolbar-button-with-text toolbar-button__advanced-".concat(e)}))}})});
},{"core-js/modules/es6.function.name":"WtEG","core-js/modules/web.dom.iterable":"hFdU","./constants":"iJA9"}],"Focm":[function(require,module,exports) {
